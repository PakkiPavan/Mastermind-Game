...
class MM1 extends React.Component
{
	...
	render()
	{
		return( 
			<div>
				<Link to="/rules"><button style={{backgroundColor:'pink',border:'none',cursor:'pointer',padding:'15px',fontSize:'20px',margin:'10px'}}>How to Play</button><br/></Link>
				<div id="board">
